        ...
        <div class="px-6 py-12 bg-white shadow sm:rounded-lg sm:px-12">
          <form
            ...
            <div>
              ...
              <span class="text-red-500 text-sm float-right"><?php echo isset($_SESSION['error']['name'])  ? $_SESSION['error']['name']: '' ?></span>
            </div>
            ...
            <div>
              ...
              <span class="text-red-500 text-sm float-right"><?php echo isset($_SESSION['error']['email'])  ? $_SESSION['error']['email']: '' ?></span>
            </div>
            ...
            <div>
              ...
              <span class="text-red-500 text-sm float-right"><?php echo isset($_SESSION['error']['password'])  ? $_SESSION['error']['password']: '' ?></span>
            </div>
